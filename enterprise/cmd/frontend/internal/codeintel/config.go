...
func init() {
	...
	config.EnableCommitUpdater = config.GetBool("PRECISE_CODE_INTEL_ENABLE_COMMIT_UPDATER", "true", "Whether to enable periodically updating the commit graph for code intelligence.")
